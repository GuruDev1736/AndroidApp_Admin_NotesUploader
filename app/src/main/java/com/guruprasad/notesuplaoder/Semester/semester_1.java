...
public class semester_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_sem_1);
        Objects.requireNonNull(getSupportActionBar()).setTitle("Semester 1 Lab Manual");



        recyclerView = findViewById(R.id.sem_1_rec);


        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        FirebaseRecyclerOptions<file_model> options = new FirebaseRecyclerOptions.Builder<file_model>().setQuery(FirebaseDatabase.getInstance().getReference("admin_lab_manual").child("semester 1"),file_model.class).build();
    ...
    private void processsearch(String s) {
        ...
        FirebaseRecyclerOptions<file_model>options = new FirebaseRecyclerOptions.Builder<file_model>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("admin_lab_manual").child("semester 1").
